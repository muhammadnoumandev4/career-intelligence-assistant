...
- *LLM mode* does this **semantically** — the model reads the question and the retrieved context and responds. There is no keyword list; any phrasing of an in-scope question is understood, and out-of-scope questions are declined because the system prompt forbids answering outside the provided documents. This is the truly general path.
